...
public class ReviewController {
	...
	public ResponseEntity<?> addReply(@PathVariable("reviewId") Long reviewId, @RequestBody ReplyRequest replyRequest) {
	...
	@PutMapping("/{reviewId}")
	public ResponseEntity<?> updateReview(@PathVariable("reviewId") Long reviewId, @RequestBody ReplyRequest request) {
	...
	public ResponseEntity<?> getAllReviews() {
	    ...
	    for (Review review : reviews) {
	        ...
	        try {
	            ...
	            map.put("score", result.getScore());
	            map.put("containsProfanity", result.isContainsProfanity());
	            map.put("spamLabel", result.getSpamLabel());       // ✅ New field
	            map.put("spamScore", result.getSpamScore());   
	        } catch (Exception e) {
	            map.put("error", "Analysis failed");
	        }
